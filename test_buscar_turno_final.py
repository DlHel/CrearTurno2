...
def main():
    try:
        ...
        # Obtener el turno ID=58 de la base de datos
        print("Obteniendo turno ID=58 de la base de datos...")
        turno_original = obtener_turno_por_id(connection, 58)
        ...
        print("\nCreando turno de prueba basado en el turno ID=58...")
        turno_prueba = Turno()
        turno_prueba.id_turno = None  # No asignamos ID para buscar por configuración
        turno_prueba.nombre = "Turno de prueba"
