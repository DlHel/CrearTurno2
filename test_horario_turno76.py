...
def main():
    try:
        ...
        # Obtener el turno ID=76 de la base de datos
        print("Obteniendo turno ID=76 de la base de datos...")
        turno_original = obtener_turno_por_id(connection, 76)
        
        if not turno_original:
            print("No se encontró el turno ID=76")
            return
        ...
        # Crear un turno de prueba basado en el turno ID=76
        print("\nCreando turno de prueba basado en el turno ID=76...")
        turno_prueba = Turno()
        turno_prueba.id_turno = None  # No asignamos ID para buscar por configuración
        turno_prueba.nombre = "Turno de prueba basado en ID=76"
